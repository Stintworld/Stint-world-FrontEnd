...
import "../Stylesh/Contactus.css"
import { useEffect, useRef, useState } from "react";
import axios from "axios";


const Contactus = ({ logout }) => {
    ...
    const qmeail =localStorage.getItem("ApplicantEmail")
    const qname= localStorage.getItem("applicantName")
...
// const createQuery = axios.post("http://localhost:8080/enqueries/create", newQuery)
